...
class AdminLetterDetails extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.dispatchLetters = this.dispatchLetters.bind(this);
  }
                  ...
                  <div className="container-fluid">
                    <div className="row">
                      <div style={{
                        ...
                        <span>THE QUESTIONS USER ANSWERED</span>
                      </div>
                      <GridList>
                        {
                      ...
                      <div style={{display: 'flex', justifyContent: 'center', marginBottom: 8}}>
                        <RaisedButton
                        label="dispatch" primary={true}
                        onClick={this.dispatchLetters}/>
                      </div>
                    </div>
                  </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(AdminLetterDetails);
